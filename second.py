# second.py & verify.py both works combinely. 
# Because when each time user enters otp and click validate, it goes to verify.py. 
# At that place, entered otp is checked with otp stored in notepad.
