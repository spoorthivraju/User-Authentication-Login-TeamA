...
import random
security_question = ['What is your mother\'s maiden name?', 'What was the name of your first pet?', 'What is your favorite color?',  'Where was your best family vacation as a kid?', 'When you were young, what did you want to be when you grew up?']
